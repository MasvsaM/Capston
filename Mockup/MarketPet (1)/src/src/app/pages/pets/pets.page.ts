...
@Component({
  ...
  imports: [
    ...
    IonButton, IonIcon, IonItem, IonLabel, IonAvatar, IonBadge, IonFab,
    IonFabButton, IonGrid, IonRow, IonCol, IonChip, IonSkeletonText,
...
export class PetsPage implements OnInit {
  ...
  editPet(pet: Pet) {
    this.router.navigate(['/pet-form'], { state: { pet } });
  }
  ...
  bookAppointmentForPet(pet: Pet) {
    this.router.navigate(['/appointment-form'], { state: { pet } });
  }

  findNearby() {
    // Navigate to providers with location filter
    this.router.navigate(['/tabs/providers'], { queryParams: { nearby: true } });
  }

  viewPetProfile(pet: Pet) {
    // Navigate to detailed pet profile
    this.router.navigate(['/pet-form'], { state: { pet, viewOnly: true } });
  }
